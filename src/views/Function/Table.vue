<template>
  <div>
    1111111111111111111111111111111111111111112222222222222222
    <div style="height: 300px;width: 90%;margin: auto;border: 1px solid red;" id="box1"></div>
    <p>table</p>
    ...
    <el-table
      ...
      border
      style="width: 100%" id="table"  :height="height">
      <el-table-column
        prop="date"
        label="日期"
        width="180">
    ...
    <el-button @click="getHeight">换高</el-button>
    <div class="block">
